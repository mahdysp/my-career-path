    ...
    <>
      <style>{`
        ...
        .hero-icon {
          ...
          box-shadow: 
            0 0 40px rgba(94,106,210,0.4),
            0 0 80px rgba(94,106,210,0.2),
            inset 0 0 30px rgba(94,106,210,0.1);
        }
        ...
        .btn-main:hover {
          ...
          box-shadow: 
            ...
            0 10px 40px rgba(94,106,210,0.35),
            0 20px 60px rgba(94,106,210,0.15),
        ...
        .step-connector {
          ...
          right: 0;
          height: 2px;
          background: linear-gradient(90deg, #5E6AD2, rgba(94,106,210,0.2), #5E6AD2);
        }
      ...
      <div className="container">
        ...
        <div style={{
          ...
          {/* Hero Icon Section */}
          <div 
            className={`scale-in ${loaded ? '' : 'opacity-0'}`}
          ...
          <div className={`fade-up delay-300 ${loaded ? '' : 'opacity-0'}`} style={{
            ...
            {[
              { icon: "✓", text: "رایگان" },
              { icon: "✓", text: "بدون ثبت‌نام" },
              { icon: "✓", text: "نتیجه فوری" },
            ].map((badge, i) => (
              ...
              {isLoading ? (
                <span style={{ display: "inline-flex", alignItems: "center", gap: 10 }}>
                  <svg
                    ...
                    stroke="currentColor"
                    strokeWidth="2.5"
                    style={{ animation: "rotate-loader 1s linear infinite" }}
                  >
          ...
          <div className={`fade-up delay-600 ${loaded ? '' : 'opacity-0'}`} style={{
            ...
            {[
              {
                icon: (
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#8B92D9" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                  </svg>
                ),
                title: "تحلیل دقیق",
                desc: "بر اساس مهارت‌های شما"
              },
              {
                icon: (
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#8B92D9" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div key={i} className="feature-card" style={{ textAlign: "center" }}>
                ...
                <h3 style={{ fontSize: 14, fontWeight: 700, color: "#EDEDEF", marginBottom: 4 }}>
                  {feature.title}
                </h3>
                <p style={{ fontSize: 11, color: "#8A8F98", lineHeight: 1.6 }}>
                  {feature.desc}
                </p>
              </div>
            ))}
          ...
          {/* Steps Timeline */}
          <div className={`fade-up delay-700 ${loaded ? '' : 'opacity-0'}`} style={{
            width: "100%",
            marginBottom: 40,
          }}>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={i} style={{
                  ...
                  <div className={i === 0 ? "step-circle" : "step-circle inactive"}>
                    {step.num}
                  </div>
                  <div style={{ fontSize: 13, fontWeight: 600, color: "#EDEDEF", marginTop: 12, marginBottom: 4 }}>
                    {step.title}
                  </div>
          ...
          {/* Footer */}
          <div className={`fade-up delay-800 ${loaded ? '' : 'opacity-0'}`} style={{
            textAlign: "center",
            paddingBottom: 20,
          }}>
