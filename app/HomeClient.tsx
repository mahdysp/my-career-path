      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 10 }}>
          ...
          {/* نمای انفجاری — با اسکرول باز و دوباره جمع می‌شود.
              نمایش و متنش از پنل مدیریت کنترل می‌شود. */}
          {content.flags.explodedVisible && <ExplodedProfile copy={content.exploded} />}

          {/* نمایشگر — تصاویرش در /admin/content تنظیم می‌شود */}
